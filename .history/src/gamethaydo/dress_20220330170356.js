                    ...
                    <div className='row'>
                        <div className='col-12 col-xl-6 block-left d-flex flex-direction-row justify-content-center'>
                            <div className='clothing-box d-flex flex-column justify-content-center pt-xl-5'>
                                <div className='clothing-flex d-flex flex-direction-row justify-content-around lign-items-baseline mb-5'>
                                    <div onClick={()=>this.changeClothing(Clothing1)} onClick={()=>this.changeIdClothing(Clothing1)} className='clothing-item d-flex flex-direction-row justify-content-center align-items-center'>
                                        <img src={require('./images/trangphuc_mini/trangphuc1.png')} className='img-fluid'/>
                                    </div>
                                    <div onClick={()=>this.changeClothing(Clothing2)} onClick={()=>this.changeIdClothing(Clothing2)} className='clothing-item d-flex flex-direction-row justify-content-center align-items-center'>
                                        <img src={require('./images/trangphuc_mini/trangphuc2.png')} className='img-fluid'/>
                                    </div>
                                    <div onClick={()=>this.changeClothing(Clothing3)} onClick={()=>this.changeIdClothing(Clothing3)} className='clothing-item d-flex flex-direction-row justify-content-center align-items-center'>
                        ...
                        <div className='col-12 col-xl-6 block-right position-relative d-flex flex-direction-row justify-content-center'>
                            <div className='girl'>
                                ...
                                <img src={this.state.clothing} id={ids} className='clothing-main img-fluid'/>
                            </div>
                        </div>
                    </div>
                </div>
